...
export async function getAgentMetadata(args) {
    ...
    const plannerQuery = encodeURIComponent(`SELECT Id, DeveloperName, MasterLabel FROM GenAiPlannerDefinition WHERE DeveloperName = '${args.agentApiName}'`);
    ...
    const topicsQuery = encodeURIComponent('SELECT Id, DeveloperName, MasterLabel, Description FROM GenAiPluginDefinition ORDER BY MasterLabel');
    ...
    const actionsQuery = encodeURIComponent('SELECT Id, DeveloperName, MasterLabel, Description FROM GenAiFunctionDefinition ORDER BY MasterLabel');
